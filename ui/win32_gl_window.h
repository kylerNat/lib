...
void draw_circle(window_t wnd, real x, real y, real r, real red, real green, real blue)
{
    ...
    // glVertexAttrib4f(1, x, y, 1, r);
    // glVertexAttrib4f(2, red, green, blue, 1);
    // glVertex3f(0, 0, 1);
    ...
    // glBegin(GL_POLYGON);
    // int n_lines = 3;
    // glVertexAttrib3f(1, red, green, blue);
    ...
    // glDrawElements(GL_POLYGON, vi_circle.n_index_buffer, GL_UNSIGNED_SHORT, 0);
